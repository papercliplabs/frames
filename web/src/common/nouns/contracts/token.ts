export const nounsTokenContract = {
  ...
  abi: [
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "contract INounsDescriptor", name: "descriptor", type: "address" }],
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "contract INounsSeeder", name: "seeder", type: "address" }],
      name: "SeederUpdated",
      type: "event",
    },
    {
