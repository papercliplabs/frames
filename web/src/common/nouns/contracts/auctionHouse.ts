export const nounsAuctionHouseContract = {
  ...
  abi: [
    ...
    {
      inputs: [{ internalType: "uint256", name: "auctionCount", type: "uint256" }],
      name: "getPrices",
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint8", name: "_minBidIncrementPercentage", type: "uint8" },
      ],
      name: "initialize",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    {
      inputs: [{ internalType: "uint192", name: "_reservePrice", type: "uint192" }],
