export const beansTokenContract = {
  address: "0x65EB64E86b71f8Be76b2aedacE781209Db25879D",
  abi: [
    {
      inputs: [
        { internalType: "address", name: "_beanteamDAO", type: "address" },
        { internalType: "address", name: "_minter", type: "address" },
        { internalType: "address", name: "_descriptor", type: "address" },
        { internalType: "address", name: "_seeder", type: "address" },
        { internalType: "contract IProxyRegistry", name: "_proxyRegistry", type: "address" },
        { internalType: "address", name: "_ogBeans", type: "address" },
      ],
    ...
    },
    {
      ...
      inputs: [
        { indexed: true, internalType: "uint256", name: "tokenId", type: "uint256" },
        { indexed: false, internalType: "string", name: "typeRef", type: "string" },
      ],
      name: "BeanCreated",
      type: "event",
    },
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "address", name: "beanteamDAO", type: "address" }],
      name: "BeanteamDAOUpdated",
      type: "event",
    },
    {
      anonymous: false,
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "contract IBeansDescriptor", name: "descriptor", type: "address" }],
    ...
    },
    {
      ...
      inputs: [
        { indexed: true, internalType: "uint256", name: "tokenId", type: "uint256" },
        { indexed: false, internalType: "address", name: "ogBeanAddy", type: "address" },
      ],
      name: "OgBeanMinted",
      type: "event",
    },
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "contract IBeansSeeder", name: "seeder", type: "address" }],
      name: "SeederUpdated",
      type: "event",
    },
    {
    ...
    {
      inputs: [{ internalType: "uint256", name: "beanId", type: "uint256" }],
      name: "burn",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    },
    {
      inputs: [],
      name: "descriptor",
      outputs: [{ internalType: "contract IBeansDescriptor", name: "", type: "address" }],
      stateMutability: "view",
      type: "function",
    },
    {
    ...
    },
    {
      inputs: [],
      name: "ogBeansList",
      outputs: [{ internalType: "contract IOGBeansList", name: "", type: "address" }],
      stateMutability: "view",
      type: "function",
    },
    {
    ...
    },
    {
      inputs: [],
      name: "seeder",
      outputs: [{ internalType: "contract IBeansSeeder", name: "", type: "address" }],
      stateMutability: "view",
      type: "function",
    },
    {
    ...
    {
      inputs: [{ internalType: "address", name: "_beanteamDAO", type: "address" }],
      name: "setBeanteamDAO",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    {
      inputs: [{ internalType: "contract IBeansDescriptor", name: "_descriptor", type: "address" }],
      name: "setDescriptor",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    {
      inputs: [{ internalType: "contract IBeansSeeder", name: "_seeder", type: "address" }],
      name: "setSeeder",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
