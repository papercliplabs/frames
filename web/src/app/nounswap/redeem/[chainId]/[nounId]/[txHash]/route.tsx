...
async function response(
  ...
  if (req.method === "POST") {
    ...
    if (frameRequest.untrustedData.buttonIndex == 1) {
      sendAnalyticsEvent("link_clicked", { app: "nounswap/redeem", label: "View Tx" });
      ...
      sendAnalyticsEvent("link_clicked", { app: "nounswap/redeem", label: "NounSwap" });
