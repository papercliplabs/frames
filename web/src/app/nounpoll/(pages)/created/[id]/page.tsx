...
export default function CreatedPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex h-dvh w-screen flex-col items-center gap-9 bg-[#120D17] p-4 pt-[10vh] text-white md:pt-[15vh]">
      ...
      <div className="justify-centers flex flex-col items-center text-center">
        ...
        <div className="text-[#898989]">
          You can share directly to warpcast, or copy the frame link and cast it manually.
        </div>
      </div>
