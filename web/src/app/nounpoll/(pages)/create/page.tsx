...
export default function NounPollCreator() {
  ...
  return (
    <div className="flex h-screen w-screen flex-col-reverse gap-6 overflow-x-hidden pb-16 pt-4 md:gap-0 md:pb-0 md:pt-0 lg:flex-row">
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem className="grow">
          <FormControl>
            {type == "textarea" ? (
              <Textarea placeholder={placeholder} className="max-h-[200px] resize-none shadow-sm" {...field} />
            ) : (
              <Input placeholder={placeholder} className={cn("h-[48px] shadow-sm", className)} {...props} {...field} />
            )}
          </FormControl>
