  ...
  return generateImageResponse({
    ...
    layers: [
      ...
      })),
      {
        ...
        src: (
          <div
            tw="flex flex-col w-full h-full text-[#FFFFFF] justify-top items-center "
            style={{ gap: 70 * SCALER, padding: 40 * SCALER }}
          >
            <div tw="text-[37px] tracking-[4.18px] font-bold w-full justify-center">LEADERBOARD</div>
            <div tw="flex w-full justify-between text-[21.6px] tracking-[1.73px]">
              ...
              <div tw="flex flex-col w-1/2 items-center" style={{ gap: 40 * SCALER }}>
                ...
                {topTrainers.map((entry, i) => (
                  <span key={i} tw="text-[17px] tracking-[0.168px] items-center" style={{ height: 36 * SCALER }}>
                    {entry.username}
                  </span>
                ))}
              </div>
