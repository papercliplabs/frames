        ...
        <div tw="flex flex-row justify-start w-full ">
          ...
          <div tw="flex flex-col justify-end items-start pl-[80px] ">
            <div tw="flex flex-col">
              <span tw="text-[#6B6B6B] pb-[8px]">{auction.status == "finished" ? "Winning Bid" : "Current bid"}</span>
              <span>{auction.highestBidFormatted}</span>
            </div>
            <div tw="flex flex-col pt-[80px] ">
              <span tw="text-[#6B6B6B] pb-[8px]">{auction.status == "finished" ? "Winner" : "Highest Bidder"}</span>
